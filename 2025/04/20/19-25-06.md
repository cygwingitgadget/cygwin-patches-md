# [PATCH 2/4] Cygwin: CI: Run stress-ng

| Header | Value |
|--------|-------|
| **From** | Jon Turney <jon.turney@dronecode.org.uk> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-04-20T20:25:06+01:00 |
| **Message-ID** | [20250420192510.3483-3-jon.turney@dronecode.org.uk](https://inbox.sourceware.org/cygwin-patches/20250420192510.3483-3-jon.turney@dronecode.org.uk) |

---

**Thread**: [thread](19-25-04.thread.md#:~:text=2025/04/20/19-25-06)
