# Re: [PATCH] Cygwin: handle GetProcAddress returning NULL in GetArm64ProcAddress.

| Header | Value |
|--------|-------|
| **From** | Corinna Vinschen <corinna-cygwin@cygwin.com> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-04-02T22:29:48+02:00 |
| **Message-ID** | [Z-2ePII02PBpvN0S@calimero.vinschen.de](https://inbox.sourceware.org/cygwin-patches/Z-2ePII02PBpvN0S@calimero.vinschen.de) |

---

**Thread**: [thread](20-01-58.thread.md#:~:text=2025/04/02/20-29-48)
