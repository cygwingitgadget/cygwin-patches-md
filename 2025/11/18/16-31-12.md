# Re: [PATCH v2 2/2] Cygwin: dll_init: Don't call dll::init() twice for DLL_LOAD.

| Header | Value |
|--------|-------|
| **From** | Corinna Vinschen <corinna-cygwin@cygwin.com> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-11-18T17:31:12+01:00 |
| **Message-ID** | [aRyfUJ-BKOnskONG@calimero.vinschen.de](https://inbox.sourceware.org/cygwin-patches/aRyfUJ-BKOnskONG@calimero.vinschen.de) |

---

**Thread**: [thread](14-09-33.thread.md#:~:text=2025/11/18/16-31-12)
