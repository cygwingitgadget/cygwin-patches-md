# [PATCH v5 1/3] Cygwin: cygheap: Add lock()/unlock() method

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-07-22T09:31:31+09:00 |
| **Message-ID** | [20250722003142.4722-2-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20250722003142.4722-2-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](00-31-30.thread.md#:~:text=2025/07/22/00-31-31)
