# [PATCH v6 1/3] Cygwin: cygheap: Add lock()/unlock() method

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-07-22T15:44:00+09:00 |
| **Message-ID** | [20250722064415.1590-2-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20250722064415.1590-2-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](06-43-59.thread.md#:~:text=2025/07/22/06-44-00)
