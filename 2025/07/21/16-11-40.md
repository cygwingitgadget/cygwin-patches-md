# [PATCH v4 1/3] Cygwin: cygheap: Add lock()/unlock() method

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-07-22T01:11:40+09:00 |
| **Message-ID** | [20250721161151.1053-2-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20250721161151.1053-2-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](16-11-39.thread.md#:~:text=2025/07/21/16-11-40)
