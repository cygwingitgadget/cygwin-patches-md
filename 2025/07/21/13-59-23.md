# Re: [PATCH v3 2/3] Cygwin: spawn: Lock cygheap from refresh_cygheap() until child_copy()

| Header | Value |
|--------|-------|
| **From** | Corinna Vinschen <corinna-cygwin@cygwin.com> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-07-21T15:59:23+02:00 |
| **Message-ID** | [aH5HuxuSf_3FELo6@calimero.vinschen.de](https://inbox.sourceware.org/cygwin-patches/aH5HuxuSf_3FELo6@calimero.vinschen.de) |

---

**Thread**: [thread](13-46-16.thread.md#:~:text=2025/07/21/13-59-23)
