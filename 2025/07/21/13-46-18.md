# [PATCH v3 2/3] Cygwin: spawn: Lock cygheap from refresh_cygheap() until child_copy()

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-07-21T22:46:18+09:00 |
| **Message-ID** | [20250721134628.2908-3-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20250721134628.2908-3-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](13-46-16.thread.md#:~:text=2025/07/21/13-46-18)
