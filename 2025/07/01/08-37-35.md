# [PATCH] Cygwin: console: Set ENABLE_PROCESSED_INPUT when disable_master_thread

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-07-01T17:37:35+09:00 |
| **Message-ID** | [20250701083742.1963-1-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20250701083742.1963-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](08-37-35.thread.md#:~:text=2025/07/01/08-37-35)
