...
| **Date** | 2025-12-19T09:09:59+01:00 |
| **Message-ID** | [754f35dc-43d2-d7ef-22b3-e677a22814a8@gmx.de](https://inbox.sourceware.org/cygwin-patches/754f35dc-43d2-d7ef-22b3-e677a22814a8@gmx.de) |

---

**Thread**: [thread](07-48-21.thread.md#:~:text=2025/12/19/08-09-59)
...
```
  out state, so that state = 2 means we just saw CSI, state = 3 means we
  saw OSC, state = 4 means we saw a number after CSI, etc.
...
The two previous `if`/`else if` both have the same `state == 2` condition
