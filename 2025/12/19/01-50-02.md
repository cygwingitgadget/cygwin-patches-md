...
| **Date** | 2025-12-19T02:50:02+01:00 |
| **Message-ID** | [8928B19D-7415-4357-8B66-9B88E972EBD0@gmx.de](https://inbox.sourceware.org/cygwin-patches/8928B19D-7415-4357-8B66-9B88E972EBD0@gmx.de) |

---

**Thread**: [thread](../18/07-27-54.thread.md#:~:text=2025/12/19/01-50-02)

Hi Takashi,

that commit message sounds very good to me, thank you for that!

And I think you're right about app execution aliases only allowing `.exe`. At least in practice that'll be the case.
...
Subject: Re: [PATCH v4 5/5] Cygwin: termios: Handle app execution alias in is_console_app()
