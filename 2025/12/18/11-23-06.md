# [PATCH v2 2/4] Cygwin: uinfo: allow to override user account as primary group

| Header | Value |
|--------|-------|
| **From** | Corinna Vinschen <corinna-cygwin@cygwin.com> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-12-18T12:23:06+01:00 |
| **Message-ID** | [20251218112308.1004395-3-corinna-cygwin@cygwin.com](https://inbox.sourceware.org/cygwin-patches/20251218112308.1004395-3-corinna-cygwin@cygwin.com) |

---

**Thread**: [thread](11-23-04.thread.md#:~:text=2025/12/18/11-23-06)
