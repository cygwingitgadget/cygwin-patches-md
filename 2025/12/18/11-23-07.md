# [PATCH v2 3/4] Cygwin: uinfo: fix overriding group from SAM comment on AD member machines

| Header | Value |
|--------|-------|
| **From** | Corinna Vinschen <corinna-cygwin@cygwin.com> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-12-18T12:23:07+01:00 |
| **Message-ID** | [20251218112308.1004395-4-corinna-cygwin@cygwin.com](https://inbox.sourceware.org/cygwin-patches/20251218112308.1004395-4-corinna-cygwin@cygwin.com) |

---

**Thread**: [thread](11-23-04.thread.md#:~:text=2025/12/18/11-23-07)
