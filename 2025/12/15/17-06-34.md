# [PATCH v2 2/3] Cygwin: is_console_app(): deal with the `.bat`/`.cmd` file extensions first

| Header | Value |
|--------|-------|
| **From** | Johannes Schindelin via GitGitGadget <gitgitgadget@gmail.com> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-12-15T17:06:34Z |
| **Message-ID** | [8e9732407ff389b2bcf978b79d8308e0471980fe.1765818395.git.gitgitgadget@gmail.com](https://inbox.sourceware.org/cygwin-patches/8e9732407ff389b2bcf978b79d8308e0471980fe.1765818395.git.gitgitgadget@gmail.com) |

---

**Thread**: [thread](14-37-17.thread.md#:~:text=2025/12/15/17-06-34)
