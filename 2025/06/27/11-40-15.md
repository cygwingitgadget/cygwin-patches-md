# [PATCH v2 3/3] Cygwin: pipe: Make pipe_data_available() return PDA_UNKNOWN

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-06-27T20:40:15+09:00 |
| **Message-ID** | [20250627114103.30364-3-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20250627114103.30364-3-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](11-40-13.thread.md#:~:text=2025/06/27/11-40-15)
