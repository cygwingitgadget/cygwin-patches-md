# [PATCH v2 1/3] Cygwin: pipe: Fix SSH hang with non-cygwin pipe reader

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-06-27T20:40:13+09:00 |
| **Message-ID** | [20250627114103.30364-1-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20250627114103.30364-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](11-40-13.thread.md#:~:text=2025/06/27/11-40-13)
