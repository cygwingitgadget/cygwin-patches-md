# [PATCH] Cygwin: Only return true from try_to_debug() if we launched a JIT debugger

| Header | Value |
|--------|-------|
| **From** | Jon Turney <jon.turney@dronecode.org.uk> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2025-05-17T15:00:53+01:00 |
| **Message-ID** | [20250517140054.1826-1-jon.turney@dronecode.org.uk](https://inbox.sourceware.org/cygwin-patches/20250517140054.1826-1-jon.turney@dronecode.org.uk) |

---

**Thread**: [thread](14-00-53.thread.md#:~:text=2025/05/17/14-00-53)
