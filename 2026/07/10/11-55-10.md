# [PATCH v2] Cygwin: Add AArch64 support for signal handling and ucontext

| Header | Value |
|--------|-------|
| **From** | Chandru Kumaresan <chandru.kumaresan@multicorewareinc.com> |
| **To** | cygwin-patches@cygwin.com <cygwin-patches@cygwin.com> |
| **Date** | 2026-07-10T11:55:10Z |
| **Message-ID** | [PN0P287MB029504FE0939EFA34AEC78E592FD2@PN0P287MB0295.INDP287.PROD.OUTLOOK.COM](https://lore.kernel.org/git/PN0P287MB029504FE0939EFA34AEC78E592FD2@PN0P287MB0295.INDP287.PROD.OUTLOOK.COM) |

---

**Thread**: [thread](11-55-10.thread.md#:~:text=2026/07/10/11-55-10)
...
- [Cygwin-exceptions-Add-AArch64-support-for-signal-han.patch](Cygwin-exceptions-Add-AArch64-support-for-signal-han.patch) (application)
