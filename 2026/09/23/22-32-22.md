# [PATCH v5] Cygwin: console: Abort setting disable_master_thread when no con.owner

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2026-09-24T07:32:22+09:00 |
| **Message-ID** | [20260923223230.3504-1-takashi.yano@nifty.ne.jp](https://lore.kernel.org/git/20260923223230.3504-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](22-32-22.thread.md#:~:text=2026/09/23/22-32-22)
