# [PATCH v3 2/6] Cygwin: pty: Add workaround for handling of backspace when pcon enabled

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2026-03-19T19:55:16+09:00 |
| **Message-ID** | [20260319105608.597-3-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20260319105608.597-3-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](../02/14-24-36.thread.md#:~:text=2026/03/19/10-55-16)
