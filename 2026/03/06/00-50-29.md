# [PATCH v2] Cygwin: pty: Fix nat pipe hand-over when pcon is disabled

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2026-03-06T09:50:29+09:00 |
| **Message-ID** | [20260306005037.1934-1-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20260306005037.1934-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](00-50-29.thread.md#:~:text=2026/03/06/00-50-29)
