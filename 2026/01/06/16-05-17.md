# [PATCH 1/1] Renaming AC_ARG_WITH([cross_bootstrap] to ... in order to avoid confusion.

| Header | Value |
|--------|-------|
| **From** | J.H. vd Water <dhr-incognito@xs4all.nl> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2026-01-06T17:05:17+01:00 |
| **Message-ID** | [20260106160517.4785-1-dhr-incognito@xs4all.nl](https://inbox.sourceware.org/cygwin-patches/20260106160517.4785-1-dhr-incognito@xs4all.nl) |

---

**Thread**: [thread](16-05-17.thread.md#:~:text=2026/01/06/16-05-17)
