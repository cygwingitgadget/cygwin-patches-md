# Re: [PATCH v3 1/2] Cygwin: pty: Introduce a helper function get_handle_from_process()

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2026-06-23T10:16:48+09:00 |
| **Message-ID** | [20260623101648.f4a5b4731b05759b3f392add@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20260623101648.f4a5b4731b05759b3f392add@nifty.ne.jp) |

---

**Thread**: [thread](../13/14-06-18.thread.md#:~:text=2026/06/23/01-16-48)
