...
| **Date** | 2026-08-03T19:54:43+09:00 |
| **Message-ID** | [20260803195443.2ef79fe1f505267789e9e12e@nifty.ne.jp](https://lore.kernel.org/git/20260803195443.2ef79fe1f505267789e9e12e@nifty.ne.jp) |

---

**Thread**: [thread](../../07/17/03-10-12.thread.md#:~:text=2026/08/03/10-54-43)

Hi Johannes,

On Wed, 22 Jul 2026 22:29:44 +0200 (CEST)
...
I implemented two different ways, one uses independent reserved flag,
the other uses special value ((fhandler_base *) -1) as a reservation
marker.

I'll submit both patches, so please review the one you think is the
better approach.
