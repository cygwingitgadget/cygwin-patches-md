# [PATCH] Cygwin: signal: Fix high load when retrying to process pending signal

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2024-12-12T17:32:14+09:00 |
| **Message-ID** | [20241212083223.1891-1-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20241212083223.1891-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](08-32-14.thread.md#:~:text=2024/12/12/08-32-14)
