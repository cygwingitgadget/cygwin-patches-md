# [PATCH 1/3] Cygwin: signal: Remove queue entry from the queue chain when cleared

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2024-12-05T21:25:41+09:00 |
| **Message-ID** | [20241205122604.939-2-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20241205122604.939-2-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](12-25-40.thread.md#:~:text=2024/12/05/12-25-41)
