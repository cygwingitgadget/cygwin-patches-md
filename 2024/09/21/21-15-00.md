...
| **Date** | 2024-09-22T06:15:00+09:00 |
| **Message-ID** | [20240921211508.1196-1-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20240921211508.1196-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](21-15-00.thread.md#:~:text=2024/09/21/21-15-00)
...
index c686df650..f58db06bc 100644
...
+	      break;
 	    default:
 	      ...
 	      nbytes = (size_t) -1;
@@ -410,22 +435,10 @@ fhandler_pipe::raw_read (void *ptr, size_t& len)
...
@@ -503,21 +592,10 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
 	    {
 	      do
 		{
...
-		    }
 		  ...
 		  if (waitret == WAIT_OBJECT_0)
 		    break;
@@ -530,8 +608,7 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
 		    }
