# [PATCH v5] Cygwin: pipe: Switch pipe mode to blocking mode by default

| Header | Value |
|--------|-------|
| **From** | Takashi Yano <takashi.yano@nifty.ne.jp> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2024-09-20T18:22:45+09:00 |
| **Message-ID** | [20240920092252.837-1-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20240920092252.837-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](09-22-45.thread.md#:~:text=2024/09/20/09-22-45)
...
```
 ...
 winsup/cygwin/fhandler/pipe.cc          | 640 ++++++++----------------
 ...
 7 files changed, 234 insertions(+), 516 deletions(-)
...
index c686df650..d25a7b51f 100644
...
+		break;
 		...
 		break;
 	      if (is_nonblocking ())
@@ -399,6 +365,53 @@ fhandler_pipe::raw_read (void *ptr, size_t& len)
 		  break;
 		}
 	      continue;
+	    }
...
+	      break;
 	    default:
 	      ...
 	      nbytes = (size_t) -1;
@@ -410,22 +423,10 @@ fhandler_pipe::raw_read (void *ptr, size_t& len)
...
-
 ...
 {
@@ -439,24 +440,93 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
   if (!len)
     return 0;
...
@@ -503,21 +573,10 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
 	    {
 	      do
 		{
...
-		    }
 		  ...
 		  if (waitret == WAIT_OBJECT_0)
 		    break;
@@ -530,8 +589,7 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
 		    }
...
@@ -609,55 +667,43 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
...
-  fhandler_base::fixup_after_exec ();
 ...
 int
@@ -667,12 +713,11 @@ fhandler_pipe::dup (fhandler_base *child, int flags)
   ftp->set_popen_pid (0);
...
+			     GetCurrentProcess (), &ftp->pipe_mtx,
     ...
     {
       __seterrno ();
@@ -688,34 +733,6 @@ fhandler_pipe::dup (fhandler_base *child, int flags)
       ftp->close ();
       res = -1;
     }
-  else if (query_hdl &&
...
-  ReleaseMutex (hdl_cnt_mtx);
   ...
   return res;
@@ -729,18 +746,9 @@ fhandler_pipe::close ()
...
@@ -925,7 +933,7 @@ fhandler_pipe::create (fhandler_pipe *fhs[2], unsigned psize, int mode)
   HANDLE r, w;
...
+  int64_t unique_id = 0;
   ...
   if (ret)
@@ -941,57 +949,33 @@ fhandler_pipe::create (fhandler_pipe *fhs[2], unsigned psize, int mode)
...
+  CloseHandle (fhs[0]->pipe_mtx);
 err_delete_fhs1:
   delete fhs[1];
 err_delete_fhs0:
@@ -1038,7 +1022,6 @@ nt_create (LPSECURITY_ATTRIBUTES sa_ptr, HANDLE &r, HANDLE &w,
 				 GetCurrentProcessId ());
...
@@ -1174,22 +1157,6 @@ fhandler_pipe::ioctl (unsigned int cmd, void *p)
   return 0;
 }
...
-
 ...
 {
@@ -1210,190 +1177,3 @@ fhandler_pipe::fstatvfs (struct statvfs *sfs)
   set_errno (EBADF);
   return -1;
 }
-
