...
| **Date** | 2024-09-06T18:01:08+09:00 |
| **Message-ID** | [20240906090116.59-1-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20240906090116.59-1-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](09-01-08.thread.md#:~:text=2024/09/06/09-01-08)
...
-  return false;
 ...
 off_t
@@ -333,17 +300,42 @@ fhandler_pipe::raw_read (void *ptr, size_t& len)
...
@@ -368,37 +360,6 @@ fhandler_pipe::raw_read (void *ptr, size_t& len)
...
-	      continue;
 	    default:
 	      ...
 	      nbytes = (size_t) -1;
@@ -414,18 +375,6 @@ fhandler_pipe::raw_read (void *ptr, size_t& len)
   len = nbytes;
 }
...
-
 ...
 {
@@ -439,19 +388,49 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
   if (!len)
     return 0;
...
+    chunk = avail;
   ...
   if (!(evt = CreateEvent (NULL, false, false, NULL)))
     {
@@ -503,21 +482,7 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
 	    {
 	      do
 		{
...
+		  waitret = cygwait (evt, (DWORD) 0);
 		  ...
 		  if (waitret == WAIT_OBJECT_0)
 		    break;
@@ -609,7 +574,10 @@ fhandler_pipe_fifo::raw_write (const void *ptr, size_t len)
...
+
   ...
   if (status == STATUS_THREAD_SIGNALED && nbytes == 0)
     set_errno (EINTR);
@@ -626,38 +594,16 @@ fhandler_pipe::set_close_on_exec (bool val)
...
-  fhandler_base::fixup_after_exec ();
 ...
 int
@@ -667,7 +613,6 @@ fhandler_pipe::dup (fhandler_base *child, int flags)
   ftp->set_popen_pid (0);
...
@@ -688,34 +633,6 @@ fhandler_pipe::dup (fhandler_base *child, int flags)
       ftp->close ();
       res = -1;
     }
-  else if (query_hdl &&
...
-  ReleaseMutex (hdl_cnt_mtx);
   ...
   return res;
@@ -731,16 +648,7 @@ fhandler_pipe::close ()
     }
   if (read_mtx)
     CloseHandle (read_mtx);
-  WaitForSingleObject (hdl_cnt_mtx, INFINITE);
...
@@ -955,39 +863,9 @@ fhandler_pipe::create (fhandler_pipe *fhs[2], unsigned psize, int mode)
...
-  CloseHandle (fhs[1]->select_sem);
 ...
 err_close_read_mtx:
@@ -1174,22 +1052,6 @@ fhandler_pipe::ioctl (unsigned int cmd, void *p)
   return 0;
 }
...
-
 ...
 {
@@ -1210,190 +1072,3 @@ fhandler_pipe::fstatvfs (struct statvfs *sfs)
   set_errno (EBADF);
   return -1;
 }
-
