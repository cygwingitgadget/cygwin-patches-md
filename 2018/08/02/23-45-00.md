...
| **Date** | 2018-08-02T23:45:00Z |
| **Message-ID** | [1533253512-1717-1-git-send-email-houder@xs4all.nl](https://inbox.sourceware.org/cygwin-patches/1533253512-1717-1-git-send-email-houder@xs4all.nl) |

---

**Thread**: [thread](23-45-00.thread.md#:~:text=2018/08/02/23-45-00)
