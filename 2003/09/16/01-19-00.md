# Fixing the delete queue security

| Header | Value |
|--------|-------|
| **From** | Pierre A. Humblet <pierre@phumblet.no-ip.org> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2003-09-16T01:19:00Z |
| **Message-ID** | [3.0.5.32.20030915211808.0081d6d0@incoming.verizon.net](https://inbox.sourceware.org/cygwin-patches/3.0.5.32.20030915211808.0081d6d0@incoming.verizon.net) |

---

**Thread**: [thread](01-19-00.thread.md#:~:text=2003/09/16/01-19-00)
...
- [delqueue.diff](delqueue.diff) (text)
