...
| **Date** | 2022-02-21T14:36:44+01:00 |
| **Message-ID** | [15a4784f8008ca1b89b7b995cf18734932e90177.1645450518.git.johannes.schindelin@gmx.de](https://inbox.sourceware.org/cygwin-patches/15a4784f8008ca1b89b7b995cf18734932e90177.1645450518.git.johannes.schindelin@gmx.de) |

---

**Thread**: [thread](13-36-16.thread.md#:~:text=2022/02/21/13-36-44)

The previous commit changed the input files, and to make reviewers' life
easier, the change to this auto-generated file was split out.

Signed-off-by: Johannes Schindelin <johannes.schindelin@gmx.de>
---
```
 winsup/cygwin/devices.cc | 1494 ++++++++++++++++++++------------------
 1 file changed, 788 insertions(+), 706 deletions(-)

```

```diff
diff --git a/winsup/cygwin/devices.cc b/winsup/cygwin/devices.cc
index 6ef886db49..a0762f292c 100644
