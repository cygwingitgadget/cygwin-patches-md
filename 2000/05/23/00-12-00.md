# Re[2]: error_start patch

| Header | Value |
|--------|-------|
| **From** | Egor Duda <deo@logos-m.ru> |
| **To** | cygpatch <cygwin-patches@sourceware.cygnus.com> |
| **Date** | 2000-05-23T00:12:00Z |
| **Message-ID** | [2465.000523@logos-m.ru](https://inbox.sourceware.org/cygwin-patches/2465.000523@logos-m.ru) |

---

**Thread**: [thread](../22/10-27-00.thread.md#:~:text=2000/05/23/00-12-00)
