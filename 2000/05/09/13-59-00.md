# [Patch]: fhandler_base::puts_readahead crashes sometimes.

| Header | Value |
|--------|-------|
| **From** | Corinna Vinschen <corinna@vinschen.de> |
| **To** | cygpatch <cygwin-patches@sourceware.cygnus.com> |
| **Date** | 2000-05-09T13:59:00Z |
| **Message-ID** | [39187C1A.EAB5BFD2@vinschen.de](https://inbox.sourceware.org/cygwin-patches/39187C1A.EAB5BFD2@vinschen.de) |

---

**Thread**: [thread](13-59-00.thread.md#:~:text=2000/05/09/13-59-00)
