# Re: proc(5) Cygwin man page

| Header | Value |
|--------|-------|
| **From** | Brian Inglis <Brian.Inglis@SystematicSw.ab.ca> |
| **To** | cygwin-patches@cygwin.com |
| **Date** | 2020-11-24T23:44:22-07:00 |
| **Message-ID** | [a5802c8c-d3a2-021b-9f6d-7acc7fb79a8e@SystematicSw.ab.ca](https://inbox.sourceware.org/cygwin-patches/a5802c8c-d3a2-021b-9f6d-7acc7fb79a8e@SystematicSw.ab.ca) |

---

**Thread**: [thread](../23/22-10-59.thread.md#:~:text=2020/11/25/06-44-22)

On 2020-11-24 14:03, Brian Inglis wrote:
...
> > remembers to update them when the relevant content is updated), which causes 
> > the build date to be used.
>
>
...
- [specialnames.tar.xz](specialnames.tar.xz) (application)
