# [RFD, PATCH]: Set "hidden" attribute when creating files/dirs/symlinks with trailing dot

| Header | Value |
|--------|-------|
| **From** | Corinna Vinschen <cygwin-patches@cygwin.com> |
| **To** | cygpatch <cygwin-patches@cygwin.com> |
| **Date** | 2001-11-11T16:53:00Z |
| **Message-ID** | [20011111165300.KjL0QdoRlIx_fvXkMvk9xl_XoaGlYpiZilLrIb6__lg@z](https://inbox.sourceware.org/cygwin-patches/20011111165300.KjL0QdoRlIx_fvXkMvk9xl_XoaGlYpiZilLrIb6__lg@z) |

---

**Thread**: [thread](16-53-00.thread.md#:~:text=2001/11/11/16-53-00)
