# [PATCH] Fwd: Re: #define Win32_Winsock fails in 1.1.8]

| Header | Value |
|--------|-------|
| **From** | Danny Smith <danny_r_smith_2001@yahoo.co.nz> |
| **To** | mingw-dvlpr@lists.sourceforge.net |
| **Date** | 2001-03-10T01:52:00Z |
| **Message-ID** | [20010310095215.27469.qmail@web6403.mail.yahoo.com](https://inbox.sourceware.org/cygwin-patches/20010310095215.27469.qmail@web6403.mail.yahoo.com) |

---

**Thread**: [thread](01-52-00.thread.md#:~:text=2001/03/10/01-52-00)
