...
| **Date** | 2021-01-25T18:39:49+09:00 |
| **Message-ID** | [20210125093950.1386-4-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20210125093950.1386-4-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](09-39-46.thread.md#:~:text=2021/01/25/09-39-49)
...
@@ -846,8 +955,61 @@ fhandler_pty_slave::reset_switch_to_pcon (void)
...
@@ -889,9 +1051,10 @@ fhandler_pty_slave::write (const void *ptr, size_t len)
   return towrite;
 }
...
+      /* Fixup handles */
       ...
       cygheap_fdenum cfd (false);
@@ -2865,7 +3040,6 @@ fhandler_pty_slave::close_pseudoconsole (tty *ttyp)
 {
