...
| **Date** | 2021-01-27T03:32:02+09:00 |
| **Message-ID** | [20210126183202.209-5-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20210126183202.209-5-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](18-31-58.thread.md#:~:text=2021/01/26/18-32-02)
...
@@ -1041,14 +1058,14 @@ fhandler_pty_slave::reset_switch_to_pcon (void)
     return;
   if (isHybrid)
     return;
...
+  get_ttyp ()->pcon_activated = false;
 ...
 ssize_t __stdcall
@@ -1090,7 +1107,7 @@ fhandler_pty_slave::write (const void *ptr, size_t len)
...
@@ -1108,21 +1125,63 @@ fhandler_pty_slave::mask_switch_to_pcon_in (bool mask)
...
@@ -1148,6 +1207,7 @@ fhandler_pty_slave::read (void *ptr, size_t& len)
   DWORD bytes_in_pipe;
...
+  char *ptr0 = (char *) ptr;
   ...
   if (bg <= bg_eof)
@@ -1162,7 +1222,7 @@ fhandler_pty_slave::read (void *ptr, size_t& len)
...
@@ -1276,7 +1336,7 @@ fhandler_pty_slave::read (void *ptr, size_t& len)
...
@@ -1381,7 +1441,7 @@ fhandler_pty_slave::read (void *ptr, size_t& len)
 out:
...
+  mask_switch_to_pcon_in (false, totalread > 0 && ptr0[totalread - 1] == '\n');
 ...
 int
@@ -1422,7 +1482,7 @@ fhandler_pty_slave::tcgetattr (struct termios *t)
       {
...
@@ -1537,7 +1597,7 @@ fhandler_pty_slave::ioctl (unsigned int cmd, void *arg)
...
@@ -1952,7 +2012,7 @@ fhandler_pty_master::write (const void *ptr, size_t len)
...
+  if (to_be_read_from_pcon () && get_ttyp ()->pcon_activated)
     {
       tmp_pathbuf tp;
       char *buf = (char *) ptr;
@@ -2047,7 +2107,7 @@ fhandler_pty_master::tcgetattr (struct termios *t)
...
@@ -2096,7 +2156,7 @@ fhandler_pty_master::ioctl (unsigned int cmd, void *arg)
       if (get_ttyp ()->winsize.ws_row != ((struct winsize *) arg)->ws_row
 	  || get_ttyp ()->winsize.ws_col != ((struct winsize *) arg)->ws_col)
 	{
-	  if (get_ttyp ()->h_pseudo_console && get_ttyp ()->pcon_pid)
...
@@ -2390,7 +2450,7 @@ fhandler_pty_master::pty_master_fwd_thread (const master_fwd_thread_param_t *p)
 	}
       ssize_t wlen = rlen;
       char *ptr = outbuf;
...
+      if (p->ttyp->pcon_activated)
 	{
 	  ...
 	  int state = 0;
@@ -2900,9 +2960,7 @@ fhandler_pty_slave::setup_pseudoconsole (bool nopcon)
...
@@ -2916,11 +2974,32 @@ fhandler_pty_slave::setup_pseudoconsole (bool nopcon)
       return false;
     }
...
+  HPCON hpcon;
   ...
   do
     {
@@ -2929,11 +3008,11 @@ fhandler_pty_slave::setup_pseudoconsole (bool nopcon)
...
+					 inherit_cursor, &hpcon);
 	...
 	{
 	  if (res != S_OK)
@@ -2956,9 +3035,7 @@ fhandler_pty_slave::setup_pseudoconsole (bool nopcon)
...
@@ -2987,6 +3064,7 @@ fhandler_pty_slave::setup_pseudoconsole (bool nopcon)
...
@@ -3042,7 +3120,12 @@ fhandler_pty_slave::setup_pseudoconsole (bool nopcon)
...
@@ -3073,16 +3156,29 @@ fhandler_pty_slave::setup_pseudoconsole (bool nopcon)
...
+  release_output_mutex ();
 ...
 cleanup_pcon_in:
@@ -3094,6 +3190,8 @@ cleanup_helper_process:
...
+  get_ttyp ()->pcon_activated = false;
 skip_close_hello:
   CloseHandle (goodbye);
   CloseHandle (hr);
@@ -3101,16 +3199,15 @@ skip_close_hello:
 cleanup_heap:
...
@@ -3223,9 +3421,9 @@ fhandler_pty_slave::term_has_pcon_cap (const WCHAR *env)
...
+  get_ttyp ()->pcon_activated = true;
   ...
   get_ttyp ()->pcon_start = true;
@@ -3256,7 +3454,7 @@ fhandler_pty_slave::term_has_pcon_cap (const WCHAR *env)
 	Sleep (1);
     }
   while (len);
-  get_ttyp ()->h_pseudo_console = NULL;
...
@@ -3363,7 +3561,7 @@ fhandler_pty_slave::transfer_input (xfer_dir dir, HANDLE from, tty *ttyp,
   if (dir == to_nat)
     {
...
+      if (ttyp->pcon_activated)
 	...
 	cp_to = GetConsoleCP ();
@@ -3379,7 +3577,7 @@ fhandler_pty_slave::transfer_input (xfer_dir dir, HANDLE from, tty *ttyp,
...
+  if (dir == to_cyg && ttyp->pcon_activated)
     { /* from handle is console handle */
       ...
       DWORD n;
@@ -3463,7 +3661,7 @@ fhandler_pty_slave::transfer_input (xfer_dir dir, HANDLE from, tty *ttyp,
