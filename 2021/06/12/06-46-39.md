...
| **Date** | 2021-06-11T23:46:39-07:00 |
| **Message-ID** | [20210612064639.2107-1-mark@maxrnd.com](https://inbox.sourceware.org/cygwin-patches/20210612064639.2107-1-mark@maxrnd.com) |

---

**Thread**: [thread](06-46-39.thread.md#:~:text=2021/06/12/06-46-39)
...
```
 ...
 winsup/cygwin/release/3.2.1    |    1 +
 winsup/doc/utils.xml           |   65 +-
 winsup/utils/cygmon.cc         | 1240 ++++++++++++++++++++++++++++++++
 winsup/utils/mingw/Makefile.am |    6 +
 5 files changed, 1311 insertions(+), 2 deletions(-)
 create mode 100644 winsup/utils/cygmon.cc
...
index 6ebe68fa6..2170b92b3 100644
...
+- New tool: cygmon, a sampling profiler of Cygwin programs with their DLLs.
...
@@ -288,6 +288,67 @@ coreutils-5.3.0-6         GNU core utilities (includes fileutils, sh-utils and t
 
   </refentry>
 
+  <refentry id="cygmon">
+    <refmeta>
+      <refentrytitle>cygmon</refentrytitle>
+      <manvolnum>1</manvolnum>
+      <refmiscinfo class="manual">Cygwin Utilities</refmiscinfo>
+    </refmeta>
+
+    <refnamediv>
+      <refname>cygmon</refname>
+      <refpurpose>Sampling profiler of Cygwin programs with their DLLs</refpurpose>
+    </refnamediv>
+
+    <refsynopsisdiv>
+    <screen>
+cygmon [OPTION]... PROGRAM [ARG]...
+cygmon [OPTION]... -p PID
+cygmon -i FILE...
+    </screen>
+    </refsynopsisdiv>
+
+    <refsect1 id="cygmon-options">
+      <title>Options</title>
+      <screen>
...
@@ -2514,7 +2575,7 @@ strace [OPTIONS] -p &lt;pid&gt;
...
@@ -2538,7 +2599,7 @@ $ strace -o tracing_output -w sh -c 'while true; do echo "tracing..."; done' &am
...
+    <para> Note that <command>strace</command> is a native Windows program
       and so does not rely on the Cygwin DLL itself (you can verify this with
       <command>cygcheck</command>). As a result it does not understand
...
index a14725902..b744d1cda 100644
--- a/winsup/utils/mingw/Makefile.am
+++ b/winsup/utils/mingw/Makefile.am
@@ -20,6 +20,7 @@ AM_CXXFLAGS=-fno-exceptions -fno-rtti -fno-use-cxa-atexit $(flags_common) $(CFLA
