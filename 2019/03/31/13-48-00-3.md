...
| **Message-ID** | [20190331134718.1407-2-takashi.yano@nifty.ne.jp](https://inbox.sourceware.org/cygwin-patches/20190331134718.1407-2-takashi.yano@nifty.ne.jp) |

---

**Thread**: [thread](06-20-00.thread.md#:~:text=2019/03/31/13-48-00-3)
...
@@ -435,7 +450,8 @@ fhandler_console::read (void *pv, size_t& buflen)
 	      toadd = tmp;
 	    }
...
+		   == (wincap.has_con_24bit_colors () ? '2' : VK_SPACE)
 	    ...
 	    toadd = "";
@@ -855,10 +871,24 @@ fhandler_console::open (int flags, mode_t)
...
+		    | cflags);
   ...
   debug_printf ("opened conin$ %p, conout$ %p", get_handle (),
 		get_output_handle ());
@@ -878,6 +908,22 @@ fhandler_console::open_setup (int flags)
 int
...
+
   ...
   if (!have_execed)
@@ -987,6 +1033,13 @@ fhandler_console::output_tcsetattr (int, struct termios const *t)
...
+    }
   ...
   if (res)
@@ -1043,7 +1096,11 @@ fhandler_console::input_tcsetattr (int, struct termios const *t)
...
+    flags |= ENABLE_VIRTUAL_TERMINAL_INPUT;
   ...
   int res;
   if (flags == oflags)
@@ -1602,11 +1659,32 @@ static const char base_chars[256] =
...
+  int r, g, b;
   ...
   switch (c)
     {
@@ -1678,6 +1756,40 @@ fhandler_console::char_command (char c)
 	     case 37:		/* WHITE foreg */
...
+	       break;
 	     case 39:
 	       ...
 	       break;
@@ -1705,6 +1817,40 @@ fhandler_console::char_command (char c)
...
+	       break;
 	     case 49:
 	       ...
 	       break;
@@ -2143,10 +2289,12 @@ fhandler_console::write_normal (const unsigned char *src,
...
@@ -2394,6 +2542,8 @@ fhandler_console::write (const void *vsrc, size_t len)
...
+	    con.state = eatpalette;
 	    ...
 	    con.state = eattitle;
 	  src++;
@@ -2416,6 +2566,21 @@ fhandler_console::write (const void *vsrc, size_t len)
 	    src++;
 	    break;
 	  }
+	case eatpalette:
